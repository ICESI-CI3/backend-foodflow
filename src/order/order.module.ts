...
@Module({
  imports: [TypeOrmModule.forFeature([Order, Product, Ingredient, ProductToIngredient, Location, Logistic])],
  controllers: [OrderController, ProductController, IngredientsController, LocationController],
  providers: [OrderService, ProductService, IngredientsService, LocationService, LogisticService],
})
